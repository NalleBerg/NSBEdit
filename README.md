...
- **Multiple UI languages** — Dansk (Danish), English, Íslenska (Icelandic), Norsk bokmål (Norwegian), Suomi (Finnish), and Svenska (Swedish); switch instantly from the *GUI Language* menu (no restart required)
