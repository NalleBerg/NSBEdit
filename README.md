...
A lightweight, standalone RTF notepad and programming editor for Windows. **v2026.08.01.10**
...
- **Edition 3** — About dialog shows Edition: 3 below the version number (translated in all 15 UI languages via `ABOUT_EDITION`)
