...
- **Multiple UI languages** — Dansk (Danish), Deutsch (German), English, Español (Spanish), Français (French), Íslenska (Icelandic), Norsk bokmål (Norwegian), Suomi (Finnish), and Svenska (Swedish); switch instantly from the *GUI Language* menu (no restart required); menu always shows each language in its own native name
