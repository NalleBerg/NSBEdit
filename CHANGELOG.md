# Changelog
## v2026.08.01.08 (Fixes: Find/Replace on code tabs; AI query-box paste crash and invisible text) - 01.08.2026 08:06
...
- **Fix: multi-line AI prompt truncated on Send**: a pasted multi-line prompt was cut short when sent because the buffer was sized for single-CR line breaks while the control returns CRLF. The whole prompt is now read intact.
## v2026.07.30.09 (All translations complete) - 30.07.2026 09:09
